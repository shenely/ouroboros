...
libgeoid.setshape.argtypes = [ctypes.c_double, ctypes.c_double]
...
libgeoid.center2datum.argtypes = [ctypes.c_double, ctypes.c_double,
...
libgeoid.datum2center.argtypes = [ctypes.c_double, ctypes.c_double,
                                  c_double_p, c_double_p]

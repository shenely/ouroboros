...
liborbele.kep2rec.argtypes = [
    ob_orbele, np_vector3, np_vector3
]
liborbele.kep2rec.restype = ctypes.c_int
def kep2rec(sma, ecc, ta,
            aop, raan, inc):
    kep = ob_orbele(
        sma=sma, ecc=ecc, ta=ta,
